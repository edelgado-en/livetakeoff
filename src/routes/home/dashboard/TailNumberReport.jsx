...
const TailNumberReport = () => {
  ...
  const getTailStatsDetails = async (tailStatsDetails) => {
    ...
    try {
      const response = await api.getTailStatsDetails(
        tailStatsDetails.tailNumber
      );
  ...
  const handleRedirectToJobsQueue = () => {
    ...
    if (currentUser.isCustomer) {
      localStorage.setItem(
        "statusSelected",
        JSON.stringify({ id: "All", name: "All Open Jobs" })
      );
    } else {
      localStorage.setItem(
        "statusSelected",
        JSON.stringify({ id: "O", name: "All Open Jobs" })
      );
    }
              ...
              <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-white focus:outline-none">
                ...
                <div className="flex-shrink-0 border-t border-gray-200 p-4">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    Search list of {totalTailStats} tail numbers
                  </p>
                        ...
                        {({ open }) => (
                          <>
                            <div className="relative" style={{ width: "75px" }}>
                              ...
                              >
                                <Listbox.Options
                                  className="absolute left-0 z-10 mt-1 max-h-72 w-full overflow-auto w-40
                    ...
                    {!loading && (
                      ...
                      >
                        {tailStats.map((tail, index) => (
                          <li
                            key={index}
                            onClick={() => getTailStatsDetails(tail)}
                          >
                            <div
                              className={`${
                                tail.showDetails
                                ...
                                {currentUser.showSpendingInfo &&
                                  currentUser.canSeePrice && (
                                    <div className="text-green-700 font-medium">
                                      $
                                      {tail.total_price
                                        ? tail.total_price?.toLocaleString()
                                        : 0}
                                    </div>
                                  )}
                                <div>
                          ...
                          <div>
                            <div className="md:flex md:items-center md:justify-between gap-8 xl:space-x-4 xl:border-b xl:pb-6">
                              <div className="flex gap-4">
                                ...
                                <span
                                  className="text-gray-500 relative whitespace-nowrap"
                                  style={{ top: "6px" }}
                                >
                                  {tailStatsDetails?.aircraft_type.name}
                                </span>
                              </div>
                            ...
                            <aside className="mt-8 xl:hidden">
                              ...
                              <div className="space-y-5">
                                  ...
                                  currentUser.canSeePrice && (
                                    <div className="flex items-center space-x-2">
                                      ...
                                      <span className="text-sm font-medium text-green-700">
                                        $
                                        {tailStatsDetails?.total_price.toLocaleString()}
                                      </span>
                                    </div>
                                  )}
                                <div className="flex items-center space-x-2">
                                  ...
                                  <span className="text-sm font-medium text-gray-900">
                                    {tailStatsDetails?.total_jobs.toLocaleString()}{" "}
                                    total{" "}
                                ...
                                <div className="flex items-center space-x-2">
                                  ...
                                  <span className="text-sm font-medium text-gray-900">
                                    {tailStatsDetails?.total_invoiced_jobs.toLocaleString()}{" "}
                                    invoiced{" "}
                                    <span className="text-gray-500">
                                      job(s)
                                    </span>
                                ...
                                <div className="flex items-center space-x-2">
                                  ...
                                  <span className="text-sm font-medium text-gray-900">
                                    {tailStatsDetails?.total_completed_jobs.toLocaleString()}{" "}
                                    completed{" "}
                                    <span className="text-gray-500">
                                      job(s)
                                    </span>
                                ...
                                {!currentUser.isCustomer && (
                                  <div className="flex items-center space-x-2">
                                    ...
                                    <span className="text-sm font-medium text-gray-900">
                                      {tailStatsDetails?.total_canceled_jobs.toLocaleString()}{" "}
                                      canceled{" "}
                                      <span className="text-gray-500">
                                        job(s)
                                      </span>
                                ...
                                <div
                                  ...
                                  onClick={() => handleRedirectToJobsQueue()}
                                >
                                  <div className="w-6">
                                  ...
                                  <span
                                    className={`text-sm font-medium ${
                                      tailStatsDetails?.total_open_jobs > 0
                                        ? "text-blue-600 underline"
                                        : "text-gray-900"
                                    } `}
                                  >
                                    {tailStatsDetails?.total_open_jobs.toLocaleString()}{" "}
                                    open{" "}
                                    <span
                                      className={`${
                                        tailStatsDetails?.total_open_jobs > 0
                                    ...
                                    {tailStatsDetails?.first_job_date && (
                                      <>
                                        ...
                                        <ReactTimeAgo
                                          date={
                                            new Date(
                                              tailStatsDetails?.first_job_date[0].requestDate
                                            )
                                          }
                                          locale="en-US"
                                          timeStyle="twitter"
                              ...
                              <div className="mt-6 space-y-8 border-t border-gray-200 py-6 pb-8">
                                <div>
                                  ...
                                  {tailStatsDetails?.project_manager_stats
                                    ?.length === 0 && (
                                  ...
                                  <ul role="list" className="mt-3 space-y-3">
                                    {tailStatsDetails?.project_manager_stats?.map(
                                      (user, index) => (
                                          ...
                                          <div className="flex gap-2 text-sm">
                                            <div className="flex-shrink-0">
                                              <img
                                                ...
                                                src={
                                                  "https://res.cloudinary.com/datidxeqm/image/upload/v1/" +
                                                  user.user__profile__avatar
                                                }
                                                alt=""
                                              />
                                            </div>
                                            <div className="text-sm font-medium text-gray-900 relative top-1">
                                              {user.user__first_name}{" "}
                                              {user.user__last_name}
                                            </div>
                                            <div className="text-gray-500 relative top-1 text-right flex-1">
                                              {user.job_count} job(s) completed
                                            </div>
                                          </div>
                                        </li>
                                      )
                              ...
                              <div className="space-y-8 border-t border-b border-gray-200 py-6 pb-8">
                                <div>
                                  ...
                                  {tailStatsDetails?.airport_stats?.length ===
                                    0 && (
                                    <div className="text-center text-sm text-gray-500 pt-10">
                                      No airports found
                                    </div>
                                  ...
                                  <ul role="list" className="mt-3 space-y-3">
                                    {tailStatsDetails?.airport_stats?.map(
                                      (airport, index) => (
                                        <li key={index} className="">
                                          <div className="flex gap-6 text-sm">
                                            <div className="text-sm font-medium text-gray-900 relative top-1 w-60 truncate overflow-ellipsis py-2">
                                              {airport.airport__name}
                                            </div>
                                            <div className="text-gray-500 relative top-1 text-right flex-1 py-2">
                                              {airport.job_count} job(s)
                                            </div>
                                          </div>
                                        </li>
                                      )
                            ...
                            <div className="space-y-8 border-t border-b border-gray-200 py-6">
                              <div>
                                ...
                                {tailStatsDetails?.service_stats?.length ===
                                  0 && (
                                  <div className="text-center text-sm text-gray-500 pt-10">
                                    No services found
                                  </div>
                                ...
                                <ul role="list" className="mt-3 space-y-3">
                                  {tailStatsDetails?.service_stats?.map(
                                    (service, index) => (
                                      <li
                                        key={index}
                                      ...
                                      >
                                        <div className="flex gap-6 text-sm">
                                          <div className="text-sm text-gray-900 relative top-1 w-60 truncate overflow-ellipsis py-2">
                                            {service.service__name}
                                          </div>
                                          <div className="text-gray-500 relative top-1 text-right flex-1 py-2">
                                            {service.services_count.toLocaleString()}{" "}
                                            time(s)
                                          </div>
                                        </div>
                                      </li>
                                ...
                                {tailStatsDetails?.service_stats?.length >
                                  0 && (
                                  <div
                                    onClick={() => toggleRecentServices()}
                                    className="flex gap-2 justify-end text-sm pt-6 text-red-600 hover:text-red-900 cursor-pointer text-right"
                                  >
                                    {showRecentServices
                                      ? "Hide Recent Services"
                              ...
                              <div className="space-y-8 border-t border-b border-gray-200 py-6 pb-8">
                                <div>
                                  ...
                                  <ul className="mt-3 space-y-3">
                                    {tailStatsDetails?.recent_services?.map(
                                      (service, index) => (
                                        <li
                                          key={index}
                                          className="hover:bg-gray-50 rounded-md"
                            ...
                            <div className="space-y-8 border-t border-b border-gray-200 py-6">
                              <div>
                                <h2 className="text-md font-medium text-gray-900">
                                  All Retainers Performed
                                </h2>

                                {tailStatsDetails?.retainer_service_stats
                                  ?.length === 0 && (
                                  <div className="text-center text-sm text-gray-500 pt-10">
                                    No retainers found
                                  </div>
                                ...
                                <ul role="list" className="mt-3 space-y-3">
                                  {tailStatsDetails?.retainer_service_stats?.map(
                                    (retainer_service, index) => (
                                      <li
                                        key={index}
                                        className="hover:bg-gray-50 rounded-md"
                                      >
                                        <div className="flex gap-6 text-sm">
                                          <div className="text-sm text-gray-900 relative top-1 w-60 truncate overflow-ellipsis py-2">
                                            {
                                              retainer_service.retainer_service__name
                                            }
                                          </div>
                                          <div className="text-gray-500 relative top-1 text-right flex-1 py-2">
                                            {retainer_service.services_count.toLocaleString()}{" "}
                                            time(s)
                                          </div>
                                        </div>
                                      </li>
                              ...
                              {tailStatsDetails?.retainer_service_stats
                                ?.length > 0 && (
                                <div
                                  onClick={() => toggleRecentRetainers()}
                                  className="flex gap-2 justify-end text-sm text-red-600 hover:text-red-900 cursor-pointer text-right"
                                >
                                  {showRecentRetainers
                                    ? "Hide Recent Retainers"
                                    : "Show Recent Retainers"}
                                  {showRecentRetainers ? (
                                    <ChevronUpIcon
                                      className="h-4 w-4 relative"
                                      style={{ top: "2px" }}
                            ...
                            {showRecentRetainers && (
                              <div className="space-y-8 border-t border-b border-gray-200 py-6 pb-8">
                                <div className="">
                                  ...
                                  <ul className="mt-3 space-y-3">
                                    {tailStatsDetails?.recent_retainer_services?.map(
                                      (retainer, index) => (
                                        <li
                                          key={index}
                                          className="hover:bg-gray-50 rounded-md"
                                        >
                                          <div className="flex gap-6 text-sm">
                                            <div className="text-sm text-gray-900 relative top-1 w-60 truncate overflow-ellipsis py-2">
                                              {retainer.retainer_service__name}
                                            </div>
                                            <div className="text-gray-500 relative top-1 text-right flex-1 py-2">
                                              <ReactTimeAgo
                                                date={
                                                  new Date(retainer.timestamp)
                                                }
                                                locale="en-US"
                                                timeStyle="twitter"
                                              />
                        ...
                        >
                          <div>
                            <div className="divide-y divide-gray-200">
                              ...
                              <div className="pt-6">
                                {tailStatsDetails?.recent_activity?.length ===
                                  0 && (
                                ...
                                <ul className="-mb-8">
                                  {tailStatsDetails?.recent_activity.map(
                                    (activity, eventIdx) => (
                                      <li key={activity.id}>
                                        <div className="relative pb-8">
                                          {eventIdx !==
                                          tailStatsDetails.recent_activity
                                            .length -
                                            1 ? (
                                            <span
                      ...
                      <aside className="hidden xl:block xl:pl-8">
                        <div className="space-y-5">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm font-medium text-gray-900">
                              {tailStatsDetails?.total_jobs.toLocaleString()}{" "}
                              total{" "}
                              <span className="text-gray-500">job(s)</span>
                            </span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className="w-6">
                        ...
                        <div className="mt-6 space-y-8 border-t border-gray-200 py-6">
                          <div>
                            ...
                            {tailStatsDetails?.project_manager_stats?.length ===
                              0 && (
                              <div className="text-center text-sm text-gray-500 pt-10">
                                No completed jobs found
                              </div>
                                ...
                                (user, index) => (
                                  <li key={index} className="">
                                    <div className="flex gap-2 text-sm">
                                      ...
                                      <div className="text-gray-500 relative top-1 flex-1 text-right">
                                        {user.job_count} job(s) completed
                                      </div>
                                    </div>
                                  </li>
                            ...
                            <ul role="list" className="mt-3 space-y-3">
                              {tailStatsDetails?.airport_stats?.map(
                                (airport, index) => (
                                  <li key={index} className="">
                                    <div className="flex gap-6 text-sm">
                                      <div className="text-sm font-medium text-gray-900 relative top-1 w-52 truncate overflow-ellipsis py-2">
                                        {airport.airport__name}
                                      </div>
                                      <div className="text-gray-500 relative top-1 text-right flex-1 py-2">
                                        {airport.job_count.toLocaleString()}{" "}
                                        job(s)
                                      </div>
                                    </div>
                                  </li>
                ...
                >
                  {tailStats.map((tail, index) => (
                    <li key={index} onClick={() => getTailStatsDetails(tail)}>
                      <div
                        className={`${
                          tail.showDetails ? " border-2 border-red-500" : ""
                        }
                                                                            cursor-pointer relative flex justify-between space-x-3 xl:px-6 lg:px-6 md:px-6 sm:px-2 xs:px-2 pr-6 py-5 hover:bg-gray-50 text-sm`}
                      >
                        <div className="">
