...
const JobCancelModal = ({ isOpen, handleClose, updateJobStatus, jobDetails }) => {
                ...
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <Dialog.Title as="h3" className="text-lg font-medium leading-6 text-gray-900 relative top-1">
                      Cancel Job <span className="text-gray-500 text-sm">{jobDetails.purchase_order}</span>
                    </Dialog.Title>
                    
                    <div className="mt-4 py-3">
                      <p className="text-sm text-gray-500 py-3">
                        Please confirm your request to cancel job for Tail 
                        <span className="font-semibold ml-1">{jobDetails.tailNumber}</span>
                      </p>
                    </div>
                  </div>
                </div>
