...
import { ChevronLeftIcon, ChevronDownIcon, CheckIcon } from '@heroicons/react/outline'
              ...
              >
                <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-white focus:outline-none">
                  ...
                  <div className="flex-shrink-0 border-t border-gray-200 p-4">
                    ...
                    {/* MOBILE */}
                    <form className="mt-2 flex justify-between space-x-4" action="#">
                      <div className="">
