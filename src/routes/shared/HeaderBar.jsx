  ...
  return (
    <Popover className="relative bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        >
          <Link to={"/login"} className="flex justify-start lg:w-0 lg:flex-1">
            <span className="sr-only">Livetakeoff</span>
            <img className="h-8 w-auto sm:h-10" src={logo} alt="livetakeoff" />
            <div className="font-bold text-xl relative top-1 ml-1">
              LiveTakeoff
            </div>
          </Link>
          ...
          <div className="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
            <div className="px-5 pt-5 pb-6">
              <div className="flex items-center justify-between">
                <div>
                  <img className="h-8 w-auto" src={logo} alt="Livetakeoff" />
                </div>
                <div className="-mr-2">
                  <Popover.Button
                    className="inline-flex items-center justify-center rounded-md 
