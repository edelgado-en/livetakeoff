    ...
    <AnimatedPage>
      ...
      {!loading && errorMessage == null && (
        <div className="mt-4 m-auto max-w-4xl px-4">
          ...
          <h1 className="text-3xl font-semibold text-gray-700 relative top-1">
            Services
          </h1>
          <div className="mx-auto mt-8 max-w-5xl pb-8">
            <div className="flex justify-between">
              <h2 className="text-xl font-bold text-gray-600 uppercase tracking-wide">
                Standard
              </h2>
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="focus:outline-none">
                      <div className="grid grid-cols-3 text-xl pb-2">
                        <div
                          className={`${
                            service.status === "C" ? "col-span-2" : "col-span-3"
                          } font-medium text-gray-900 relative top-1`}
                        >
                          {service.name}
                        </div>
