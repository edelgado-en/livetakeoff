...
const Footer = () => {
  ...
  return (
    <div className="border-t border-slate-900/5 py-8 pb-24">
      ...
      />
      <p className="mt-2 text-center text-md leading-6 text-slate-500">
      ...
      {!location.pathname.includes("shared") && (
        <div className="mt-6 flex items-center justify-center space-x-4 text-md font-medium leading-6 text-slate-700">
